...
typedef enum e_Error {
    ...
    AIO4C_SELECT_ERROR = 9,
#endif /* AIO4C_HAVE_POLL */
    AIO4C_READ_ERROR = 10,
    AIO4C_WRITE_ERROR = 11,
    AIO4C_BUFFER_OVERFLOW_ERROR = 12,
    AIO4C_BUFFER_UNDERFLOW_ERROR = 13,
    AIO4C_CONNECTION_STATE_ERROR = 14,
    AIO4C_EVENT_HANDLER_ERROR = 15,
    AIO4C_THREAD_LOCK_INIT_ERROR = 16,
    AIO4C_THREAD_LOCK_TAKE_ERROR = 17,
    AIO4C_THREAD_LOCK_RELEASE_ERROR = 18,
    AIO4C_THREAD_LOCK_DESTROY_ERROR = 19,
    AIO4C_THREAD_CONDITION_INIT_ERROR = 20,
    AIO4C_THREAD_CONDITION_WAIT_ERROR = 21,
    AIO4C_THREAD_CONDITION_NOTIFY_ERROR = 22,
    AIO4C_THREAD_CONDITION_DESTROY_ERROR = 23,
    AIO4C_THREAD_SELECTOR_INIT_ERROR = 24,
    AIO4C_THREAD_SELECTOR_SELECT_ERROR = 25,
    AIO4C_THREAD_SELECTOR_WAKE_UP_ERROR = 26,
    AIO4C_THREAD_CREATE_ERROR = 27,
    AIO4C_THREAD_CANCEL_ERROR = 28,
    AIO4C_THREAD_JOIN_ERROR = 29,
    AIO4C_ALLOC_ERROR = 30,
    AIO4C_JNI_FIELD_ERROR = 31,
    AIO4C_MAX_ERRORS = 32
} Error;
